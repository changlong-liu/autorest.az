...
def step_mn_create(test, rg, checks=None):
    ...
    test.cmd('az managed-network mn create '
             ...
             'g}/providers/Microsoft.Network/virtualNetworks/{vn_3}/subnets/subnetA\\"}},{{\\"id\\":\\"/subscriptions/{'
             'subscription_id}/resourceGroups/{rg}/providers/Microsoft.Network/virtualNetworks/{vn_3}/subnets/subnetB\\'
             '"}}]}}" '
...
def step_mn_group_create(test, rg, checks=None):
    ...
    test.cmd('az managed-network mn group create '
             ...
             'works/{vn}/subnets/subnetA" id="/subscriptions/{subscription_id}/resourceGroups/{rg}/providers/Microsoft.'
             'Network/virtualNetworks/{vn_2}/subnets/subnetB" '
